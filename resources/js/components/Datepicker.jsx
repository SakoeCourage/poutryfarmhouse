...
export default function Datepicker(props) {
  ...
  return (
    <div>
        ...
        <DatePicker placeholderText={props.placeholder ?? 'select date'} dateFormat={props.format ?? 'yyyy/MM/dd'} className=" outline-none grow" disabled={props.disabled} selected={startDate} onChange={(date) => handleChange(date)} />
        </nav>
    </div>
  )
}
